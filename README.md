Structure:
- backend/handlers contains logic for creating and reading notifications and adt events.
- backend/migrations contains migrations to set up db schema
- main.go is the backend entry point.
- frontend/src/common contains generic UI components to be used throughout the app
- frontend/src/pages contains web pages
...
Data Format?
We have patients, providers, adt_events, & notifications.
...
How to tell if a ADT event is a dupe?
